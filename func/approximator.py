...
def mapping1(mapping1_x, a1, b1, c1):
    return a1 * mapping1_x**2 + b1 * mapping1_x + c1


def mapping2(mapping2_x, a2, b2, c2):
    return a2 * mapping2_x**3 + b2 * mapping2_x + c2


def mapping3(mapping3_x, a3, b3, c3):
    return a3 * mapping3_x**3 + b3 * mapping3_x**2 + c3
